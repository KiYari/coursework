        ...
        <div class="row justify-content-center">
            <div class="chat-container col-5">
                    ...
                    <?php
                        foreach (DB::table('comments')->where('section_id',$id)->get() as $c){
                            if($c->from == Auth::user()->id){
                                ...
                                echo '<div class="chat-text">'.$c->value.'</div>';
                ...
                <div class="form-group mt-3 mb-0">
                    <form id="create_comment" <?php if(!foo($id)){echo 'hidden';}?> method="POST" enctype="multipart/form-data" action="http://phosphene/teacher_page/create_comment">
                        @csrf
